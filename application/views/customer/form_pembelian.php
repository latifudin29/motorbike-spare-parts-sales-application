<div class="row">
    <div class="col-md-12">
    <form action="customer/simpan_pembelian" method="POST">
        <div class="form-group">
            <label>Kode Pembelian</label>
            <input type="text" class="form-control" name="kode_beli" id="kode_beli" value="<?php echo $kodeurut; ?>" readonly/>
        </div>
        ...
        <table class="table table-bordered">
            <tr>
                ...
                <th>
                    ...
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#Modal">Tambah PO</button>
                </th>
            </tr>
            <tr>
            <?php $i=1; $no=1;?>
            <?php foreach($this->cart->contents() as $items): ?>
                ...
                <td>
                    <a href="customer/hapus_cart/<?php echo $items['rowid'] ?>" class="btn btn-warning btn-sm">X</a>
                </td>
            </tr>
            <?php $i++; $no++;?>
            <?php endforeach; ?>
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="tgl_beli" value="<?php echo date('Y-m-d') ?>">
            
            <button type="submit" class="btn btn-primary">Simpan</button>
            <a href="customer/data_pembelian" class="btn btn-default">Close</a>
        </div>
    </form>
    </div>
</div>
...
<div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="customer/tambah_cart" method="POST">
...
$(document).ready(function(){
    ...
    $.ajax({
        type : 'POST',
        url : '<?php echo base_url('customer/cek_barang') ?>',
        Cache : false,
        dataType: "json",
        data : 'kode_barang='+id,
