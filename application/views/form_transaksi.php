<div class="row">
	<div class="col-md-12">
	<form action="transaction/simpan_transaksi" method="POST">
		<div class="form-group">
            <label>Kode Pemesanan </label>
            <input type="text" class="form-control" name="kode_transaksi" id="kode_transaksi" value="<?php echo $kodeurut; ?>" readonly/>
        </div>
        ...
        <table class="table table-bordered">
          ...
          <?php $i=1; $no=1;?>
            ...
            <!-- <td><?php echo $items['kode_supplier']; ?></td> -->
            <td><?php echo $items['qty']; ?></td>
            <td>Rp. <?php echo $this->cart->format_number($items['price']); ?></td>
            <td>Rp. <?php echo $this->cart->format_number($items['subtotal']); ?></td>
            <td>
                <a href="transaction/hapus_cart/<?php echo $items['rowid'] ?>" class="btn btn-warning btn-sm">X</a>
            </td>
          </tr>
          <?php $i++; $no++;?>
            <?php endforeach; ?>
        ...
        <div class="form-group">
          ...
          <a href="transaction/pesanan_supplier" class="btn btn-default">Close</a>
        </div>
	</form>
	</div>
</div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="transaction/simpan_cart" method="POST">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#nama_barang').change(function() {
      ...
      $.ajax({
        type : 'POST',
        url : '<?php echo base_url('transaction/cek_barang') ?>',
        Cache : false,
        dataType: "json",
        data : 'kode_barang='+id,
